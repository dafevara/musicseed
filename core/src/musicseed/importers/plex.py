...
class PlexTrackRow(BaseModel):
    ...
    year: int | None
    album_year: int | None  # fallback: Plex rarely sets year on track rows
    added_at: int | None
    updated_at: int | None
    ...
    try:
        ...
        with Progress(
            ...
            for plex_track in importer.iter_tracks():
                ...
                # Plex sets year on album rows far more reliably than on track rows.
                track.year = plex_track.year or plex_track.album_year
